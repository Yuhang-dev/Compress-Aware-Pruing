...
ACTIVATION_CONTROL_DIRECTIONS="${ACTIVATION_CONTROL_DIRECTIONS:-0}"
...
python -m casafety.vpref_projection \
  ...
  --activation-control-directions "$ACTIVATION_CONTROL_DIRECTIONS" \
  --activation-control-quantile "$ACTIVATION_CONTROL_QUANTILE" \
